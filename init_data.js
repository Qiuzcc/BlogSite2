...
var article_classifier = new Article_classifier({
    classifiler:"读书笔记",
    number:1,
})
...
async.parallel([
    ...
    console.log("init article_classifier",req[1]);
    console.log("init person",req[2]);
    console.log("init photo",req[3]);
